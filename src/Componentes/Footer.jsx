    ...
    <div className="container">
      <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
        ...
        <ul className="nav col-md-4 justify-content-end list-unstyled d-flex">
          ...
          <li className="ms-1"><a className="text-muted" href="#"><svg xmlns="http://www.w3.org/2000/svg" version={1.0} width={50} height={50} viewBox="0 0 1200.000000 630.000000" x="0px" y="0px" preserveAspectRatio="xMidYMid meet">
